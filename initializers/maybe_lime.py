...
model_filename = 'initializers/river_oml_single_model_random_date_range_20200101_to_20251024.pkl'
# --- 2. pkl 파일에서 모델 불러오기 및 SHAP 적용 ---

with open(model_filename, 'rb') as file:
    loaded_model = pickle.load(file)
print(f"'{model_filename}' 파일에서 모델을 성공적으로 불러왔습니다.\n")
...
def model_predict_wrapper(input_array):
    """
...
explainer = shap.KernelExplainer(
    model_predict_wrapper, # 래핑 함수 사용
